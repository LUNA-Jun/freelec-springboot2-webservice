...
public class SecurityConfig {
    /*
        ...
        책에서 WebSecurityConfigurerAdapter 사용하는데 Deprecated됨
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .frameOptions()
                .disable()
                //h2-copnsole 화면을 사용하기 위해 해당 옵션들을 disalbe 함
                .and()
                .authorizeRequests()
                /*
                    URL별 권환 관리를 설정한 옵션의 시작점
                    authorizeRequests과 선언되어야만 antMatchers 옵션을 사용할 수 있음
                 */
                ...
                .userInfoEndpoint()
                // OAuth2로그인 성공 이후 사용자 정보를 가져올 때의 설정들을 담당함
